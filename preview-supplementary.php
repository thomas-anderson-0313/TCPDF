...
{	?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Supplementary Report Preview - <?php echo htmlentities($result->RegistrationNo);?></li>
...
<div class="col-md-6">		
    ...
    <tr>
    	<td><label class="control-label">Reg No</label></td>
    ...
    <tr>
        ...
        <td><textarea rows="3">http://<?php include('includes/ipaddress.php');?>/supplementary-report?rid=<?php echo htmlentities($result->id);?></textarea></td>
    </tr>    
    <tr>
<td><label class="control-label">Action</label></td>
<td><a href="supplementary-report?rid=<?php echo htmlentities($result->id);?>" data-toggle="modal" data-target="#pdfModal<?php echo htmlentities($result->id);?>" ><i class="fa fa-download"> Print/Download </i></a></td>
...
<div class="col-md-6">
<iframe height="450" width="350" frameborder="15" src="supplementary-report?rid=<?php echo htmlentities($result->id);?>"></iframe>
</div>
<?php $cnt=$cnt+1; }} ?>
