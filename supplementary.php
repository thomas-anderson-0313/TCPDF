...
$sql = "delete from supplementary  WHERE  id=:delid";
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" height="2%">
									<thead style="color:green;">
										<tr>
											...
											<th style="width:130px; font-size:14px;">Insurer</th>
									...
									<?php $sql = "SELECT * from supplementary ORDER BY id desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
										<tr>
											...
											<td><a href="preview-supplementary?id=<?php echo htmlentities($result->id);?>" ><i class="fa fa-eye"> Preview </i></a></td>
											...
											<td style="font-size:14px;"><a href="supplementary?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i style="color:red;" class="fa fa-trash"> Delete</i></a></td>
