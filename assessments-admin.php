...
<?php $sql = "SELECT Make,RegistrationNo,User,Status,id from Assessments ORDER BY Status asc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{
?><a class="btn btn-success btn-sm" href="assessments-admin?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Mark as Complete?')"> Mark Complete</a>
<?php } else {?>

<a class="btn btn-danger btn-sm" href="assessments-admin?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Mark as Incomplete?')"> Mark Incomplete</a>
</td>
<?php } ?>
