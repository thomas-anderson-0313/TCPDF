...
<?php 
$id=intval($_GET['id']);
$sql ="SELECT * from reinspectiondrafts where id=:id";
...
{	?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Reinspection Draft Reports Preview - <?php echo htmlentities($result->RegistrationNo);?></li>
...
<td><a href="reinspection-report-draft?rid=<?php echo htmlentities($result->id);?>" data-toggle="modal" data-target="#pdfModal<?php echo htmlentities($result->id);?>" ><i class="fa fa-download"> Print/Download </i></a></td>
		                                    ...
		                                    <iframe height="540" frameborder="15" src="reinspection-report-draft?rid=<?php echo htmlentities($result->id);?>"></iframe>
...
<div class="col-md-6">
<iframe height="450" width="350" frameborder="15" src="reinspection-report-draft?rid=<?php echo htmlentities($result->id);?>"></iframe>
<?php $cnt=$cnt+1; }} ?>
