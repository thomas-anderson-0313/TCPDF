...
<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT Desc1, Image1 FROM assessmentimages WHERE id =:uid');
	...
	{
		header("Location: change-image1.php");
	}
...
<div class="col-sm-8">
<img src="assessmentimages/<?php echo htmlentities($result->Image1);?>" width="300" height="250" style="border:solid 1px #000">
</div>
