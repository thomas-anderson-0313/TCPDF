								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" height="2%">
									<thead style="color:green;">
										<tr>
											...
											<th style="width:110px; font-size:14px;">Vehicle Make</th>
...
<?php $sql = "SELECT Make,RegistrationNo,User,Status,id from assessments ORDER BY id desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
										<tr>
											...
											<td><a href="preview-assessment?id=<?php echo htmlentities($result->id);?>" ><i class="fa fa-eye"> Preview </i></a></td>
...
?>											
											...
											<td style="font-size:14px;"><a href='edit-assessment?id=<?php echo htmlentities($result->id);?>'><i class="fa fa-edit"> Update </i></a></td>
<?php } else{ ?> 
<td style="font-size:14px;"><i style="color:gray;" class="fa fa-edit"> Update </i></td>
<?php } ?>
...
<?php if($Astatus==0){
?>											
										    <td style="font-size:14px;"><a href='edit-assessment-details?id=<?php echo htmlentities($result->id);?>'><i class="fa fa-edit"> Edit </i></a></td>
...
{
?><a class="btn btn-success btn-sm" href="assessments?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Lock report for edit?')"> Mark Complete</a>
<?php } else {?>
