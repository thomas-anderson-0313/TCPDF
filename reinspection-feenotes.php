    ...
    <div id="content-wrapper"><br><br>
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Re-inspection Fee Notes Reports</li>
        </ol>
...
<?php $sql = "SELECT Customer,RegistrationNo,Ref,FeeNoteNo,ClaimNo,id,ReportId from feenotes WHERE ReportType='reinspection' ORDER BY id desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
										...
										<tr>
											...
											<td><a href="preview-reinspection-feenote?id=<?php echo htmlentities($result->ReportId);?>" ><i class="fa fa-eye"> Preview </i></a></td>
