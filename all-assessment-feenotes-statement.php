...
<head>
  ...
  <title style="font-size:12px;">Motor assessment fee note statement</title>
    ...
    <div id="content-wrapper"><br><br>
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Fee Note Statement(Motor Assessments)</li><a style="margin-left:20px; padding-top:2px; height:30px;" class="btn btn-danger" href="feenote-statement"><i class="fa fa-window-close"> Close</i></a>
        </ol>
...
?>		
  ...
  <table style="font-size:14px;" id="example" class="display nowrap" style="width:100%">
        ...
        <tbody>
<?php 
$sql = "SELECT FeeNoteNo,Customer,RegistrationNo,PStatus,AssessmentDate,ChequeNo,PaymentDate,FeeNoteTotal from assessments order by id desc";
$query = $dbh -> prepare($sql);
...
{  ?>
            ...
            <tr>
				...
				<td><?php echo htmlentities($result->FeeNoteNo);?></td>
                <td><?php echo htmlentities($result->Customer);?></td>
                <td><?php echo htmlentities($result->RegistrationNo);?></td>			
                <td><?php echo htmlentities($result->AssessmentDate);?></td>
