...
$sql = "delete from assessmentdrafts  WHERE  draftid=:delid";
    ...
    <div id="content-wrapper"><br><br>
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Assessment Reports (Revised)</li>
        </ol>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" height="2%">
									<thead style="color:green;">
										<tr>
											...
											<th style="width:40px; font-size:14px;">Update</th>
											<th style="width:40px; font-size:14px;">Edit</th>
...
<?php $sql = "SELECT Make,RegistrationNo,User,id,draftid from assessmentdrafts ORDER BY id desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
										<tr>
											...
											<td style="font-size:14px;"><a href='edit-assessment-revised?id=<?php echo htmlentities($result->id);?>'><i class="fa fa-edit"> Update </i></a></td>
											<td style="font-size:14px;"><a href='edit-assessment-details-drafts?id=<?php echo htmlentities($result->id);?>'><i class="fa fa-edit"> Edit </i></a></td>
											<td><a href="preview-assessment-draft?id=<?php echo htmlentities($result->id);?>"><i class="fa fa-eye"> Preview </i></a></td>
											
											<td style="font-size:14px;"><a href="assessment-drafts?del=<?php echo $result->draftid;?>" onclick="return confirm('Do you want to delete');"><i style="color:red;" class="fa fa-trash"> Delete</i></a></td>
