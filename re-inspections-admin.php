...
{				?>	
										<tr>
											...
											<td style="font-size:14px;"><a href='update-reinspection?id=<?php echo htmlentities($result->id);?>'><i class="fa fa-edit"> Update </i></a></td>
...
{
?><a class="btn btn-success btn-sm" href="re-inspections-admin?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Mark as Complete?')"> Mark Complete</a>
<?php } else {?>

<a class="btn btn-danger btn-sm" href="re-inspections-admin?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Mark as Incomplete?')"> Mark Incomplete</a>
</td>
<?php } ?>
