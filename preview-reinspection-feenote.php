...
{	?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Reinspection Feenote Preview - <?php echo htmlentities($result->RegistrationNo);?></li>
...
<td><a href="reinspection-feenote-report?rid=<?php echo htmlentities($result->id);?>" data-toggle="modal" data-target="#pdfModal<?php echo htmlentities($result->id);?>" ><i class="fa fa-download"> Print/Download </i></a></td>
		                                    ...
		                                    <iframe height="540" frameborder="15" src="reinspection-feenote-report?rid=<?php echo htmlentities($result->id);?>"></iframe>
...
<div class="col-md-6">
<iframe height="450" width="350" frameborder="15" src="reinspection-feenote-report?rid=<?php echo htmlentities($result->id);?>"></iframe>
</div>
<?php $cnt=$cnt+1; }} ?>
