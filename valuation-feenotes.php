    ...
    <div id="content-wrapper"><br><br>
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Valuations Fee Notes Reports</li>
        </ol>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" height="2%">
									<thead style="color:green;">
										<tr>
											...
											<th style="width:30px; font-size:14px;">Fee Note No.</th>
											<th style="width:30px; font-size:14px;">Insured</th>
...
<?php $sql = "SELECT Customer,RegistrationNo,FeeNoteNo,ClaimNo,Insured,id,ReportId from feenotes WHERE ReportType='valuation' ORDER BY id desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
										...
										<tr>
											...
											<td style="font-size:14px;"><?php echo htmlentities($result->Insurer);?></td>
											...
											<td><a href="preview-valuation-feenote?id=<?php echo htmlentities($result->ReportId);?>" ><i class="fa fa-eye"> Preview </i></a></td>
