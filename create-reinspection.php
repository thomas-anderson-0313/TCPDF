...
$sql="INSERT INTO reinspections (Customer,Ref,Date,InstructionsBy,SumInsured,Excess,EngineType,ScrapWeight,PolicyNo,ClaimNo,Insured,ChasisNo,CurrentMileage,RegistrationNo,Year,Color,VehicleType,Make,Model,Repairer,PreparedBy,Remarks,FeeNoteRefNo,FeeNoteFee,AddMileage,MileageDesc,Photograph,Vat,FeeNoteSubTotal,FeeNoteTotal,User,YEARR,MONTH,RegDate,VatDesc,Signature,Branch,BranchCode) 
